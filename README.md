...
- 🧠 DAX (Data Analysis Expressions) – Used for calculated measures and dynamic KPIs
...
Walkthrough of Dashboard - A breakdown of each visual component and its purpose: 
  - Top Metrics (KPIs): Total ad spend, products sold, revenue, ROI, CTR
  - Channel Performance Table: Spend, ROI, CTR, allocated sales, cost per product
  - Pie & Donut Charts: Product and spend distribution across channels
  - Bar Graphs: Revenue and ROI by channel
  - Scatter Plot: Relationship between spend and products sold

Business Impact & Insights - 
- 📈 ROI and cost per product remain consistent across channels due to proportional allocation, highlighting the need for better conversion tracking.
- 📺 TV and Google Ads generate the highest revenue, suggesting potential prioritization in future campaigns.
